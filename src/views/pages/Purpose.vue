...
let titleofBar2 = "2022年博物馆珍贵文物数前十省份";
let ProvinceSale = [];
...
function formatBarData2() {
    const topTenDifferences = [
        { province: '北京市', diff: 1705996 },
        { province: '江苏省', diff: 324259 },
        { province: '河南省', diff: 223228 },
        { province: '上海市', diff: 222979 },
        { province: '辽宁省', diff: 155138 },
        { province: '天津市', diff: 141512 },
        { province: '甘肃省', diff: 123991 },
        { province: '山东省', diff: 119607 },
        { province: '四川省', diff: 115867 },
        { province: '湖北省', diff: 114596 }
    ];
    return {
    ...
    <Fluid class="grid grid-cols-12 gap-8">
        <div class="col-span-12 xl:col-span-6">
            <div class="card flex flex-col items-center">
                <div class="font-semibold text-xl mb-4">2022年中国各地区博物馆藏品数</div>
        ...
        <div class="col-span-12 xl:col-span-6">
            ...
            <div class="card">
                <div class="font-semibold text-xl mb-4">2022年中国博物馆藏品数前十省份</div>
